...
AppBar appbar(
  ...
  return AppBar(
    leading: IconButton(
        onPressed: leadingTap, icon: Icon(leading, color: Colors.white60)),
    centerTitle: true,
    title: Text(
      title,
      style: TextStyle(fontWeight: FontWeight.w400, color: Colors.white60),
    ),
    actions: [
      IconButton(
        onPressed: tap,
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: textStyle?.copyWith(
                          color: backgroundColor, fontSize: 26),
                    ),
                  ),
                )
              : Text(
